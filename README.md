...
📌 Descripción general
Panadería Mazapán es una aplicación web local diseñada para automatizar la operación de un negocio minorista, integrando ventas, inventario, compras, devoluciones, reportes y emisión de tickets.
El sistema fue desarrollado como proyecto final de la materia Aplicaciones Web, siguiendo un enfoque orientado a reglas de negocio, trazabilidad y consistencia de datos, simulando un entorno real de operación.
...
Sara Bañuelos – Líder de proyecto
Estrella Gutiérrez – UX/UI y Front-End
Valeria Macías – Base de Datos
David Rosas – Back-End (CRUD, lógica y transacciones)
Javier Muñoz – Autenticación y sesiones
Helen Zatarain – Impresión de tickets, lector de códigos, reportes y CSV
